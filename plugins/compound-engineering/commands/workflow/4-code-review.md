...
- `docs/plans/*.md` — Plan files created by `/workflow:1-plan`. These are living documents that track implementation progress (checkboxes are checked off by `/workflow:3-code`).
